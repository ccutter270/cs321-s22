...
if __name__ == "__main__":
    ...
    sequence1, sequence2 = global_alignment.read5E("rosalind_ba5f.txt")

    answer = local_alignment(sequence1, sequence2)
